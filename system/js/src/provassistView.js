...
var xcontent = '<div id="'+divid+'" class="row">';
    ...
    xcontent += '<table class="table table-sm" id="'+id+'" style="width:100%">';
...
var tk = qs['tk'];
	...
	var table = $(tableid).DataTable( {"destroy":true,"searching":false,
        ...
        "columns": [
            ...
            { "data": "assistCode"},
			{ "data": "active"},
			{"className":'deletebutton',"defaultContent": '<button type="button" class="btn btn-link"><i class="fas fa-trash-alt" </i></button>'},
			{"className":'updatebutton',"defaultContent": '<button type="button" class="btn btn-link"><i class="fa-regular fa-eye-slash"></i></button>'}	
