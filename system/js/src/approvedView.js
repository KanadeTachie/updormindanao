...
function recordTask(o) {
	...
	var row = '<div class="overridedropdown">'+
					...
					'<div class="overridedropdown-content">'+
						'<a onclick="'+callDisapprove+'" class="btn btn-warning mx-1 py-1 px-2">Override</a>'+
						'<a onclick="'+callReapprove+'" class="btn btn-success mx-1 py-1 px-2">ReApprove</a>'+
						...
						'<a onclick="'+callCert+'" class="btn btn-secondary mx-1 py-1 px-2">Certificate</a>'+
					'</div>'+
				'</div>';	
	return row;
}
